...
if __name__ == '__main__':
    ...
    parser.add_argument('-res', type=int, default=20, help='resolution (default: 200 pixels/um)')
    parser.add_argument('-theta', type=float, default=45, help='angle of incident planewave (default: 0 degrees)')
